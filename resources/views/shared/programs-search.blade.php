...
<style>
   ...
   ============================================= */
    ...
    .fp-searchbar input::placeholder {
        color: #374151;
    }
    ...
    .fp-searchbar button:hover {
        background: #e04e18;
    }

    .fp-searchbar button svg {
        color: #fff;
        display: block;
    }
   ...
   ============================ */
    ...
    .fp-av-default {
        background: linear-gradient(135deg, #0f2441, #1a3357);
    }
    ...
    .fp-apply {
        ...
        box-shadow: 0 3px 10px rgba(241, 90, 36, .25);
        white-space: nowrap;
    }
    ...
    @php function degreeClass2($level) {
        return match(strtolower($level??'')) {
            'bachelor',
            'undergraduate'=>'fp-av-bachelor',
            'master',
            'masters',
            'postgraduate'=>'fp-av-master',
            'phd',
            'doctorate'=>'fp-av-phd',
...
<div class="fp-wrap">
    ...
    <div class="fp-header">
        ...
        <div class="fp-header-stats">
            <div>
                <div class="fp-stat-val">{{ $programs->total() }}</div>
                <div class="fp-stat-lbl">Programs</div>
            </div>
            <div class="fp-stat-sep"></div>
            <div>
                <div class="fp-stat-val">50+</div>
                <div class="fp-stat-lbl">Universities</div>
            </div>
            <div class="fp-stat-sep"></div>
            <div>
                <div class="fp-stat-val">{{ date('Y') }}</div>
                <div class="fp-stat-lbl">Intake</div>
            </div>
        </div>
    </div>
    ...
    <div class="fp-mobile-bar">
        <button class="fp-mob-btn" onclick="fpToggle()">
            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 4h18v2H3zm3 7h12v2H6zm3 7h6v2H9z" />
            </svg>
            Filters
        </button>
        ...
        <div class="fp-sidebar" id="fp-sb">
            <div class="fp-sidebar-head">
                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M3 4h18v2H3zm3 7h12v2H6zm3 7h6v2H9z" />
                </svg>
                Filters
            </div>
        ...
        <div class="fp-main">
            ...
            <div class="fp-metabar">
                ...
                <span class="fp-badge">
                    <svg class="w-2.5 h-2.5" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M5 4a1 1 0 011-1h8a1 1 0 011 1v2a1 1 0 01-.293.707L11 10.414V15a1 1 0 01-.553.894l-2 1A1 1 0 017 16v-5.586L5.293 6.707A1 1 0 015 6V4z" />
                    </svg>
                    Filters Active
                </span>
                @endif
            ...
            <div class="fp-card">
                ...
                <div class="fp-card-body">
                    ...
                    <div class="fp-c-meta">
                        @if($program->field_of_study)<span><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" />
                            </svg>{{ $program->field_of_study }}</span>@endif
                        <span><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                            </svg>Fall {{date('Y')}} &amp; Spring {{date('Y')+1}}</span>
                    </div>
                </div>
                ...
                <div class="fp-price">
                    <div>
                        ...
                        <div class="fp-price-dl" style="margin-top:.45rem;">
                            Application Fee<strong>{{ $applicationFee['currency'] }} {{ number_format($applicationFee['amount'], 0) }}</strong>
                        </div>
                        <div class="fp-price-dl" style="margin-top:.25rem;">
                            Service Charge<strong>USD {{ number_format((float) $program->service_charge_usd, 0) }}</strong>
                        </div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:.4rem;width:100%;">
                        <a href="{{ route(auth()->user()->hasRole('agent') ? 'agent.applications.create' : 'student.applications.create', ['program_id' => $program->id]) }}" class="fp-apply">
                            <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @empty
            <div class="fp-empty">
                <div class="fp-empty-icon"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
