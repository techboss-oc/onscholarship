...
<div class="mb-6">
    ...
    <h1 class="text-2xl font-black text-[#0f2441] dark:text-white brand-font mt-2">Add New Category</h1>
</div>
...
<div class="max-w-2xl admin-glass p-8 rounded-3xl border border-gray-200 dark:border-gray-700">
    <form action="{{ route('admin.blog_categories.store') }}" method="POST">
        ...
        <div class="flex justify-end gap-3">
            ...
            <button type="submit" class="px-8 py-2.5 bg-[#f15a24] text-white font-bold rounded-xl hover:bg-[#d94a1c] transition shadow-md">Create Category</button>
        </div>
    </form>
</div>
@endsection
