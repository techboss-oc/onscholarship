                        ...
                        <div class="grid gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(260px,0.65fr)] lg:gap-8">
                            ...
                            <div class="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 sm:p-6 lg:p-7">
                                ...
                                <div class="mt-6 flex items-center gap-4 min-w-0">
                                    ...
                                    <img src="{{ Storage::url($testimonial->image) }}" class="w-16 h-16 rounded-full object-cover border-2 border-[#1FA463] shadow-lg" alt="{{ $testimonial->name }}">
                                    @else
                                    ...
                                    @endif
                                    <div class="min-w-0">
                                        <div class="font-black brand-font text-white text-lg leading-tight">{{ $testimonial->name }}</div>
                                        <div class="mt-1 text-sm text-white/70 leading-relaxed break-words">{{ $testimonial->university ?? 'Student' }}</div>
                                    </div>
                                </div>
                        ...
                        <div class="grid gap-5 lg:grid-cols-[minmax(0,1.35fr)_minmax(260px,0.65fr)] lg:gap-8">
                            ...
                            <div class="rounded-[28px] border border-white/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.08),rgba(255,255,255,0.03))] p-5 sm:p-6 lg:p-7">
                                ...
                                <div class="mt-6 flex items-center gap-4 min-w-0">
                                    ...
                                    <div class="min-w-0">
                                        <div class="font-black brand-font text-white text-lg leading-tight">{{ $fbTest[0] }}</div>
                                        <div class="mt-1 text-sm text-white/70 leading-relaxed break-words">{{ $fbTest[1] }}</div>
                                    </div>
                                </div>
