...
@section('meta_description', 'Learn about Onscholarship, the premier educational consulting firm connecting African students with top universities in China.')
@section('meta_keywords', 'Onscholarship, About Us, Study in China, Educational Consulting')
    ...
    <section class="py-16 md:py-20 bg-gray-50 dark:bg-[#0b1120] border-t border-gray-100 dark:border-white/10">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex flex-col lg:flex-row items-start lg:items-end justify-between gap-8">
                ...
                <a href="{{ route('register') }}" class="inline-flex items-center justify-center px-6 py-3 rounded-xl font-bold text-white transition shadow-lg"
                    ...
                    <div class="relative rounded-3xl border border-gray-100 dark:border-white/10 bg-[#0f172a] overflow-hidden shadow-2xl">
                        <div class="p-8 md:p-10">
                            ...
                            <div class="mt-8 grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <a href="{{ route('programs.index') }}" class="rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition p-5">
                                ...
                                <a href="{{ route('contact') }}" class="rounded-2xl border border-white/10 bg-white/5 hover:bg-white/10 transition p-5">
