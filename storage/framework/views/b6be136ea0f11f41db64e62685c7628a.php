...
<?php $__env->startSection('title', 'Blog & Updates | Onscholarship'); ?>
<?php $__env->startSection('meta_description', 'Read the latest news, guides, and tips about studying in China, university admissions, and scholarships.'); ?>
        ...
        <div class="flex flex-col lg:flex-row gap-10">
                ...
                <?php if($posts->count() > 0): ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        <?php $__currentLoopData = $posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="bg-white dark:bg-gray-800 rounded-3xl overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 border border-gray-100 dark:border-gray-700 flex flex-col h-full" data-aos="fade-up" data-aos-delay="<?php echo e($loop->index * 100); ?>">
                                <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="block aspect-video relative overflow-hidden group">
                                    ...
                                    <?php if($post->featured_image): ?>
                                        <img src="<?php echo e(Storage::url($post->featured_image)); ?>" alt="<?php echo e($post->title); ?>" class="w-full h-full object-cover transform group-hover:scale-105 transition-transform duration-500">
                                    <?php else: ?>
                                ...
                                <div class="p-6 flex flex-col flex-grow">
                                    <h3 class="text-xl font-bold text-[#0f2441] dark:text-white mb-3 line-clamp-2 brand-font">
                                        <a href="<?php echo e(route('blog.show', $post->slug)); ?>" class="hover:text-[#f15a24] transition-colors"><?php echo e($post->title); ?></a>
                                    </h3>
                                    ...
                                    <div class="mt-auto flex items-center justify-between pt-4 border-t border-gray-100 dark:border-gray-700">
                                        <div class="flex items-center gap-2">
                                            <div class="w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center font-bold text-[#0f2441] dark:text-white text-xs">
                                                <?php echo e(substr(optional($post->author)->name ?? 'S', 0, 1)); ?>

                                            </div>
                                            <span class="text-xs text-gray-500 dark:text-gray-400 font-medium"><?php echo e($post->published_at->format('M d, Y')); ?></span>
                                        </div>
                ...
                <?php else: ?>
                    <div class="bg-white dark:bg-gray-800 rounded-3xl p-12 text-center border border-gray-100 dark:border-gray-700 shadow-sm">
                        ...
                        <?php if(request('category')): ?>
                            <a href="<?php echo e(route('blog.index')); ?>" class="mt-4 inline-block px-6 py-2.5 bg-[#f15a24] text-white font-bold rounded-xl hover:bg-[#d94a1c] transition">Clear Filters</a>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <aside class="w-full lg:w-1/4 space-y-8">
                ...
                <div class="bg-white dark:bg-gray-800 rounded-3xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm" data-aos="fade-left">
                    ...
                    <ul class="space-y-3">
                        <li>
                            <a href="<?php echo e(route('blog.index')); ?>" class="flex items-center justify-between text-sm font-medium <?php echo e(!request('category') ? 'text-[#f15a24]' : 'text-gray-600 dark:text-gray-400 hover:text-[#f15a24] transition-colors'); ?>">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($category->posts_count > 0): ?>
                                <li>
                                    <a href="<?php echo e(route('blog.index', ['category' => $category->slug])); ?>" class="flex items-center justify-between text-sm font-medium <?php echo e(request('category') == $category->slug ? 'text-[#f15a24]' : 'text-gray-600 dark:text-gray-400 hover:text-[#f15a24] transition-colors'); ?>">
                                        <span><?php echo e($category->name); ?></span>
                                        <span class="bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300 text-xs px-2 py-0.5 rounded-full"><?php echo e($category->posts_count); ?></span>
                                    </a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="bg-[#0f2441] rounded-3xl p-6 text-center shadow-lg relative overflow-hidden" data-aos="fade-left" data-aos-delay="100">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="block w-full py-3 bg-[#f15a24] hover:bg-[#d94a1c] text-white font-bold rounded-xl transition relative z-10 shadow-md text-sm">
                        Apply Now
                    </a>
                </div>
            </aside>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hainan\resources\views/pages/blog.blade.php ENDPATH**/ ?>