...
<head>
    ...
    <title>Agent Portal - <?php echo e(config('app.name')); ?></title>
...
<body class="font-sans antialiased bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100"
    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-[#0f2441] text-white transform transition-transform duration-300"
        ...
        <div class="flex items-center justify-between h-16 px-6 border-b border-white/10">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center flex-shrink-0 px-2">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Onscholarship" class="h-8 w-auto object-contain brightness-0 invert">
            </a>
        ...
        <nav class="p-3 space-y-1 overflow-y-auto h-[calc(100vh-9rem)]">
            ...
            <a href="<?php echo e(route('agent.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('agent.dashboard') ? 'bg-[#f15a24] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Home
            </a>

            <div x-data="{ open: <?php echo e(request()->routeIs('agent.profile') || request()->routeIs('agent.sub-agencies.*') || request()->routeIs('agent.students.*') ? 'true' : 'false'); ?> }">
                ...
                <div x-show="open" x-cloak 
                    ...
                    <a href="<?php echo e(route('agent.managers.index')); ?>" 
                        class="block px-3 py-1.5 rounded-lg text-[13px] font-medium transition <?php echo e(request()->routeIs('agent.managers.*') ? 'text-[#f15a24]' : 'text-white/40 hover:text-white'); ?>">
                        Manager
                    </a>
                    <a href="<?php echo e(route('agent.agency.index')); ?>" 
                        class="block px-3 py-1.5 rounded-lg text-[13px] font-medium transition <?php echo e(request()->routeIs('agent.agency.*') ? 'text-[#f15a24]' : 'text-white/40 hover:text-white'); ?>">
                        Agency
                    </a>
                    <a href="<?php echo e(route('agent.students.index')); ?>" 
                        class="block px-3 py-1.5 rounded-lg text-[13px] font-medium transition <?php echo e(request()->routeIs('agent.students.*') ? 'text-[#f15a24]' : 'text-white/40 hover:text-white'); ?>">
                        Student
                    </a>
                </div>
            </div>

            <a href="<?php echo e(route('agent.programs.search')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('agent.programs.search') ? 'bg-[#f15a24] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('agent.scholarships')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('agent.scholarships') ? 'bg-[#f15a24] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('agent.applications.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('agent.applications.*') ? 'bg-[#f15a24] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
            ...
            <a href="<?php echo e(route('agent.commissions.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('agent.commissions.*') ? 'bg-[#f15a24] text-white' : 'text-white/70 hover:bg-white/10 hover:text-white'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.407 2.641 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.407-2.641-1M12 16v1m-7-4a4 4 0 118 0 4 4 0 01-8 0zM17 11a3 3 0 110 6 3 3 0 010-6z"/></svg>
                Commission
            </a>
        ...
        <header class="sticky top-0 z-40 bg-white/80 dark:bg-gray-800/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-700 h-16 flex items-center justify-between px-4 sm:px-6">
            ...
            <div class="flex items-center gap-3 ml-auto">
                <button @click="darkMode=!darkMode;localStorage.theme=darkMode?'dark':'light';darkMode?document.documentElement.classList.add('dark'):document.documentElement.classList.remove('dark')"
                    ...
                    <svg x-cloak x-show="darkMode" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 3v1m0 16v1m9-9h-1M4 12H3"/></svg>
                </button>
                <a href="<?php echo e(route('notifications.index')); ?>" class="relative p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition text-gray-500 dark:text-gray-400">
                ...
                <span class="text-sm font-semibold text-gray-700 dark:text-gray-300 ml-2 hidden md:block"><?php echo e(auth()->user()->name); ?></span>
            </div>
        </header>
...
<?php /**PATH C:\laragon\www\hainan\resources\views/layouts/agent.blade.php ENDPATH**/ ?>