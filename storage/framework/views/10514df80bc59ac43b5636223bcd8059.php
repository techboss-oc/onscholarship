...
<div class="fp-wrap">
    ...
    <div class="fp-header">
        ...
        <div class="fp-header-stats">
            <div><div class="fp-stat-val"><?php echo e($programs->total()); ?></div><div class="fp-stat-lbl">Programs</div></div>
            <div class="fp-stat-sep"></div>
            <div><div class="fp-stat-val">50+</div><div class="fp-stat-lbl">Universities</div></div>
            <div class="fp-stat-sep"></div>
            <div><div class="fp-stat-val"><?php echo e(date('Y')); ?></div><div class="fp-stat-lbl">Intake</div></div>
        </div>
    </div>
    ...
    <div class="fp-mobile-bar">
        ...
        <span style="font-size:.72rem;color:#4b5563;"><strong style="color:#e2e8f0;"><?php echo e($programs->total()); ?></strong> programs</span>
    </div>
    ...
    <div class="fp-layout">
        ...
        <div class="fp-sidebar" id="fp-sb">
            ...
            <form action="<?php echo e(url()->current()); ?>" method="GET">
                <?php if(request('keyword')): ?><input type="hidden" name="keyword" value="<?php echo e(request('keyword')); ?>"><?php endif; ?>
                ...
                <select name="city" class="fp-sel">
                    ...
                    <?php $__currentLoopData = ['Beijing','Shanghai','Haikou','Guangzhou','Chengdu','Wuhan','Nanjing']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <select name="degree_level" class="fp-sel">
                    ...
                    <?php $__currentLoopData = $degreeTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($t); ?>" <?php echo e(request('degree_level')==$t?'selected':''); ?>><?php echo e(ucfirst($t)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <select name="language" class="fp-sel">
                    ...
                    <option value="<?php echo e($l); ?>" <?php echo e(request('language')==$l?'selected':''); ?>><?php echo e(ucfirst($l)); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <select name="duration" class="fp-sel">
                    ...
                    <?php $__currentLoopData = [1,2,3,4,5,6]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($d); ?>" <?php echo e(request('duration')==$d?'selected':''); ?>><?php echo e($d); ?> <?php echo e($d==1?'Year':'Years'); ?></option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                ...
                <div class="fp-range">
                    <input type="number" name="min_price" value="<?php echo e(request('min_price')); ?>" placeholder="Min $" class="fp-inp">
                    <input type="number" name="max_price" value="<?php echo e(request('max_price')); ?>" placeholder="Max $" class="fp-inp">
                </div>
                ...
                <a href="<?php echo e(url()->current()); ?>" class="fp-btn-clear">✕ Clear Filters</a>
            </form>
        </div>
        ...
        <div class="fp-main">
            ...
            <form action="<?php echo e(url()->current()); ?>" method="GET" class="fp-searchbar">
                <?php if(request('degree_level')): ?><input type="hidden" name="degree_level" value="<?php echo e(request('degree_level')); ?>"><?php endif; ?>
                <?php if(request('language')): ?><input type="hidden" name="language" value="<?php echo e(request('language')); ?>"><?php endif; ?>
                ...
                <?php if(request('duration')): ?><input type="hidden" name="duration" value="<?php echo e(request('duration')); ?>"><?php endif; ?>
                <input type="text" name="keyword" value="<?php echo e(request('keyword')); ?>" placeholder="Search by university, program, or field of study…">
                <button type="submit">
            ...
            <div class="fp-metabar">
                <p>Showing <strong><?php echo e($programs->firstItem() ?? 0); ?>–<?php echo e($programs->lastItem() ?? 0); ?></strong> of <strong style="color:#f15a24;"><?php echo e($programs->total()); ?></strong> programs</p>
                <?php if(request()->hasAny(['keyword','degree_level','language','min_price','max_price','duration'])): ?>
                <span class="fp-badge">
            ...
            <?php $avClass = degreeClass2($program->degree_level); $init = strtoupper(substr($program->university->name??'U',0,1)); ?>
            <div class="fp-card">

                
                <div class="fp-avatar <?php echo e($avClass); ?>">
                    <div class="fp-av-dots"></div>
                    <?php if($program->university->logo ?? false): ?>
                        <img src="<?php echo e(Storage::url($program->university->logo)); ?>" alt="">
                    <?php else: ?>
                        <span class="fp-av-initial"><?php echo e($init); ?></span>
                    <?php endif; ?>
                </div>

                
                <div class="fp-card-body">
                    <p class="fp-c-univ"><?php echo e($program->university->name ?? 'University'); ?></p>
                    <h3 class="fp-c-prog"><?php echo e($program->name); ?></h3>
                    <p class="fp-c-loc">
                        ...
                        <?php echo e($program->university->location ?? 'China'); ?>

                    </p>
                    <div class="fp-tags">
                        <?php if($program->language): ?><span class="fp-tag fp-tg-lang"><?php echo e(ucfirst($program->language)); ?></span><?php endif; ?>
                        <?php if($program->duration_years): ?><span class="fp-tag fp-tg-dur"><?php echo e($program->duration_years); ?> <?php echo e($program->duration_years==1?'yr':'yrs'); ?></span><?php endif; ?>
                        <?php if($program->degree_level): ?><span class="fp-tag fp-tg-deg"><?php echo e(Str::title($program->degree_level)); ?></span><?php endif; ?>
                        <?php if($program->is_featured ?? false): ?><span class="fp-tag fp-tg-feat">★ Featured</span><?php endif; ?>
                    </div>
                    <div class="fp-c-meta">
                        <?php if($program->field_of_study): ?><span><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2"/></svg><?php echo e($program->field_of_study); ?></span><?php endif; ?>
                        <span><svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>Fall <?php echo e(date('Y')); ?> &amp; Spring <?php echo e(date('Y')+1); ?></span>
                    </div>
                </div>
                ...
                <div class="fp-price">
                    <div>
                        <div class="fp-price-num">
                            <?php if($program->tuition_fee_usd): ?><sup>$</sup><?php echo e(number_format($program->tuition_fee_usd,0)); ?><?php else: ?><span style="font-size:.8rem;color:#4b5563;">—</span><?php endif; ?>
                        </div>
                        <div class="fp-price-unit">/ year</div>
                        <div class="fp-price-dl" style="margin-top:.4rem;">Deadline<strong>Nov 30, <?php echo e(date('Y')); ?></strong></div>
                    </div>
                    <div style="display:flex;flex-direction:column;gap:.4rem;width:100%;">
                        <a href="<?php echo e(route(auth()->user()->hasRole('agent')?'agent.applications.index':'student.applications.create',['program_id'=>$program->id])); ?>" class="fp-apply">
                        ...
                        <?php if(auth()->user()->hasRole('student')): ?>
                            <form action="<?php echo e(route('student.wishlist.toggle')); ?>" method="POST" class="wishlist-form">
                                <?php echo csrf_field(); ?>
                                <input type="hidden" name="program_id" value="<?php echo e($program->id); ?>">
                                <?php $isSaved = auth()->user()->wishlist()->where('program_id', $program->id)->exists(); ?>
                                <button type="submit" class="fp-save <?php echo e($isSaved ? 'text-red-500' : ''); ?>" title="<?php echo e($isSaved ? 'Remove from Wishlist' : 'Add to Wishlist'); ?>">
                                    <svg class="w-3 h-3 <?php echo e($isSaved ? 'fill-current' : 'fill-none'); ?>" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"/>
                                    </svg>
                                    <?php echo e($isSaved ? 'Saved' : 'Save'); ?>
            ...
            <div class="fp-empty">
                ...
                <a href="<?php echo e(url()->current()); ?>">Clear All Filters</a>
            </div>
            <?php endif; ?>

            <?php if($programs->hasPages()): ?>
            <div style="margin-top:1.25rem;display:flex;justify-content:center;"><?php echo e($programs->links()); ?></div>
            <?php endif; ?>
...
<?php echo $__env->make($layoutName, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hainan\resources\views/shared/programs-search.blade.php ENDPATH**/ ?>