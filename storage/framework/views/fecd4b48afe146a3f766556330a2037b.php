    ...
    <div class="min-h-screen flex items-center justify-center relative py-20 px-4 sm:px-6 lg:px-8">
        ...
        <div class="relative max-w-4xl w-full z-10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-10">
                ...
                <a href="<?php echo e(route('login.type', 'student')); ?>" class="group block relative rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
                ...
                <a href="<?php echo e(route('login.type', 'agent')); ?>" class="group block relative rounded-3xl overflow-hidden bg-white dark:bg-gray-800 shadow-xl border border-gray-100 dark:border-gray-700 transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl">
            ...
            <div class="text-center mt-10">
                <a href="<?php echo e(route('home')); ?>" class="text-sm font-semibold text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white inline-flex items-center transition-colors">
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\hainan\resources\views/auth/selection.blade.php ENDPATH**/ ?>