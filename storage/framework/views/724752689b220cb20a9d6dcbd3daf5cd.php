...
<?php $__env->startSection('title', 'Complete Your Profile | Onscholarship'); ?>
            ...
            <div x-show="step === 1" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 translate-x-8" x-transition:enter-end="opacity-100 translate-x-0">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="col-span-1 md:col-span-2 space-y-2 opacity-50">
                        ...
                        <input type="email" value="<?php echo e($user->email); ?>" readonly class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none cursor-not-allowed">
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <select x-model="formData.nationality" class="w-full bg-white/5 border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#f15a24] transition appearance-none">
                            ...
                            <?php echo $__env->make('partials.countries-options', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                        </select>
                    </div>
                    <div class="space-y-2">
...
function onboardingForm() {
    return {
        step: 1,
        formData: {
            first_name: '<?php echo e($profile->first_name ?? ""); ?>',
            last_name: '<?php echo e($profile->last_name ?? ""); ?>',
            gender: '<?php echo e($profile->gender ?? ""); ?>',
            nationality: '<?php echo e($profile->nationality ?? ""); ?>',
            date_of_birth: '<?php echo e($profile->date_of_birth ? $profile->date_of_birth->format("Y-m-d") : ""); ?>',
            passport_number: '<?php echo e($profile->passport_number ?? ""); ?>',
            passport_expiry: '<?php echo e($profile->passport_expiry ? $profile->passport_expiry->format("Y-m-d") : ""); ?>',
            address: '<?php echo e($profile->address ?? ""); ?>',
        },
        uploadedDocs: {
            <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php if(in_array($doc->document_type, ['Passport', 'Diploma', 'Transcript'])): ?>
                    '<?php echo e($doc->document_type); ?>': true,
                <?php endif; ?>
        ...
        nextStep() {
            ...
            fetch('<?php echo e(route("student.onboarding.save")); ?>', {
                method: 'POST',
                headers: {
        ...
        uploadFile(event, type) {
            ...
            fetch('<?php echo e(route("student.documents.upload")); ?>', {
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>'
                },
        ...
        finish() {
            window.location.href = '<?php echo e(route("student.applications.create")); ?>';
        }
    }
}
</script>
...
<?php echo $__env->make('layouts.student', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hainan\resources\views/student/onboarding.blade.php ENDPATH**/ ?>