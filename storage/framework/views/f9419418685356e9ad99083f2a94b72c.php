...
<?php $__env->startSection('meta_description', 'The page you are looking for could not be found.'); ?>
...
<?php $__env->startSection('content'); ?>
    <div class="pt-28 pb-24 bg-gray-50 dark:bg-gray-900 min-h-screen flex items-center">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center px-8 py-4 bg-[#1FA463] text-white font-bold rounded-xl hover:bg-[#147a47] transition shadow-md">
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\hainan\resources\views/errors/404.blade.php ENDPATH**/ ?>