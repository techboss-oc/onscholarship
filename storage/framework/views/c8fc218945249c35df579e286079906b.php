...
<?php endif; ?>
                    ...
                    <div>
                        ...
                        <select id="role" name="role" required
                            ...
                            <option value="agent" <?php echo e(old('role') == 'agent' ? 'selected' : ''); ?>>💼 Agent / Consultant</option>
                        </select>
                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="mt-8 pt-5 border-t border-gray-200/50 dark:border-gray-700/50">
                        ...
                        <p class="mt-5 text-center text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <a href="<?php echo e(route('login')); ?>" class="font-bold text-[#0b49b3] hover:opacity-80 transition-opacity ml-1">Sign in here</a>
                        </p>
                    </div>
                </form>
            </div>
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\hainan\resources\views/auth/register.blade.php ENDPATH**/ ?>