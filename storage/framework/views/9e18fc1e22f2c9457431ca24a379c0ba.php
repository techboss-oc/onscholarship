...
<head>
    ...
    <title>Student Portal - <?php echo e(config('app.name')); ?></title>
    ...
    <aside class="fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 shadow-lg transform transition-transform duration-300"
        ...
        <div class="flex items-center justify-between h-16 px-6 border-b border-gray-100 dark:border-gray-700">
            <a href="<?php echo e(route('home')); ?>" class="flex items-center flex-shrink-0 px-2">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Onscholarship" class="h-8 w-auto object-contain dark:brightness-0 dark:invert">
            </a>
        ...
        <div class="p-4 border-b border-gray-100 dark:border-gray-700">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <p class="font-bold text-sm text-gray-900 dark:text-white"><?php echo e(auth()->user()->name); ?></p>
        ...
        <nav class="p-3 space-y-1 overflow-y-auto h-[calc(100vh-9rem)]">
            ...
            <a href="<?php echo e(route('student.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.dashboard') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Dashboard
            </a>
            <a href="<?php echo e(route('student.profile')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.profile') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                My Profile
            </a>
            <a href="<?php echo e(route('student.applications.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.applications.*') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
                <svg class="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/></svg>
                My Applications
            </a>
            <a href="<?php echo e(route('student.wishlist.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.wishlist.index') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
            ...
            <a href="<?php echo e(route('student.documents')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.documents') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
            ...
            <a href="<?php echo e(route('student.programs.search')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.programs.search') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
            ...
            <a href="<?php echo e(route('student.scholarships')); ?>" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition <?php echo e(request()->routeIs('student.scholarships') ? 'sidebar-active' : 'text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 hover:text-[#f15a24]'); ?>">
...
<?php /**PATH C:\laragon\www\hainan\resources\views/layouts/student.blade.php ENDPATH**/ ?>